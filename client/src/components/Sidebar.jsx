...
const Sidebar = () => {
  ...
  return (
    <div className="fixed left-0 top-0 h-screen w-64 bg-card border-r border-border overflow-y-auto z-30 hidden lg:block">
      <div className="p-6">
        {/* Logo */}
        ...
        {/* User Profile */}
        <Link to="/profile" className="flex items-center gap-3 p-3 rounded-lg hover:bg-accent mb-6 transition-colors">
